...
--INSERT INTO worker (registration_id, external_id, external_password, full_name)
--VALUES ('1', 'DM1', 'Dummy01', 'MOCKED DM1');

--INSERT INTO worker_preferences (worker_external_id, work_ssid,
...
--INSERT INTO worker_chat (worker_external_id, chat_id)
--VALUES ('DM1', 1);

INSERT INTO worker_ssid_tracking_info (worker_external_id, ssid_reported, reported)
SELECT external_id, 'NA', TO_TIMESTAMP('1900-01-01 00:00:00', 'YYYY-MM-DD HH24:MI:SS')
    FROM worker;