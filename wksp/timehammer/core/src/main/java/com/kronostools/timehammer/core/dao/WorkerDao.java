                        ...
                        .execute(Tuple.of(registrationId, fullname, WorkerProfile.WORKER.name()))
                            ...
                            .onItem().produceUni(rs -> {
                                final List<Object> preferencesParams = new ArrayList<>() {{
                                    ...
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkStartTue()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkEndTue()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchStartTue()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchEndTue()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkStartWed()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkEndWed()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchStartWed()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchEndWed()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkStartThu()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkEndThu()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchStartThu()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchEndThu()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkStartFri()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getWorkEndFri()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchStartFri()));
                                    add(CommonDateTimeUtils.parseTimeFromForm(registrationRequestForm.getDefaultTimetable().getLunchEndFri()));
